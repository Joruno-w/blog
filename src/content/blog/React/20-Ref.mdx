...
_createRef_ 这个方法本质也很简单，就是返回了一个 `{current: null}` 的对象，下面是 _createRef_ 的源码：

<img
  src="https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-11-30-055424.png"
  alt="image-20221130135424421"
  style="zoom:50%;"
/>
...
<img
  src="https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-11-30-055526.png"
  alt="image-20221130135525552"
  style="zoom:50%;"
/>
