...
[Nitro](https://nitro.build/)是 Nuxt 背后的全新服务器引擎，为 Nuxt 应用提供了统一且高效的后端运行时环境。
...
Nitro 的内部，又用到了 h3 作为 http 请求处理框架。[h3](https://h3.unjs.io/) 是一个为高性能和可移植性设计的极简 HTTP 框架，提供了**处理 HTTP 请求**和**路由**的基础功能。Nitro 在 h3 的基础上，添加了文件系统路由、资源处理和存储抽象等特性，使其成为一个功能强大的服务器框架。
