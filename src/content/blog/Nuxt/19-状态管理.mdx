...
- [Pinia](https://nuxt.com/modules/pinia)：官方推荐的Vue状态管理库
- [Harlem](https://nuxt.com/modules/harlem)：不可变的全局状态管理库
- [XState](https://nuxt.com/modules/xstate)：基于状态机的方法，具有可视化和测试状态逻辑的工具
